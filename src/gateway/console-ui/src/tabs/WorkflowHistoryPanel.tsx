  ...
  return (
    <div className="rounded-md bg-indigo-950/30 ring-1 ring-indigo-800/35 px-2.5 py-2 flex flex-col gap-2">
      ...
      {summary.missingFields.length > 0 && (
        <div className="rounded-md bg-amber-500/10 px-2.5 py-2 ring-1 ring-amber-500/20 flex flex-col gap-1">
          ...
          <div className="flex flex-wrap gap-1.5">
            {summary.missingFields.map((field) => (
              <span
                key={field}
                className="rounded-md bg-amber-400/10 px-2 py-1 text-[10px] text-amber-200 ring-1 ring-amber-400/15"
              >
                {field}
              </span>
            ))}
