...
export function DocsTab() {
  ...
  const { data: docData, loading, error } = useQuery<DocContent | null>(
    () => rpc<DocContent>('docs.get', { name: docName }),
    [lang],
  )
      ...
      >
        ...
        {docData && (
          <>
            ...
            >
              <svg className="text-slate-500 shrink-0" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
