...
export function StatCard({ label, value, accent = 'text-indigo-400' }: Props) {
  ...
  return (
    ...
    >
      ...
      />
      <span className="text-[10.5px] font-semibold text-slate-500 uppercase tracking-[0.1em]">{label}</span>
